...
int main ( int argc, char** argv )
{
    ...
    if(argc >= 2 )
    {
        ...
        // load image to the 3 channel BGR color image
...
///
    ...
    for(int i=0; i< posible_regions.size(); i++)
    {
        ...
        // int response = (int)svmClassifier.predict( p ); // OpenCV 2.4
        float response = svm->predict(p); //OpenCV 3.4
